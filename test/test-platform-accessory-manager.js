...
test("PlatformAccessoryManager#registerThermostatAccessory registers existing accessory", (context) => {
    const existingUuid = hap.uuid.generate(deviceId + "-thermostat");
    const existingPlatformAccessory =
        new mockHomebridge.platform.api.platformAccessory(
            "Test Device Thermostat",
            existingUuid,
        );
    mockHomebridge.platform.accessories = [existingPlatformAccessory];

    platformAccessoryManager.registerThermostatAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
    ...
    const mockedMethod =
        mockHomebridge.platform.api.updatePlatformAccessories.mock;
    ...
    assert.strictEqual(
        mockPlatformAccessory.context.airstageClient,
        mockHomebridge.platform.airstageClient,
    );
    ...
    assert.strictEqual(
        mockHomebridge.platform.accessories[0],
...
test("PlatformAccessoryManager#registerThermostatAccessory registers new accessory", (context) => {
    ...
    const mockedMethod =
        mockHomebridge.platform.api.registerPlatformAccessories.mock;
    assert.strictEqual(mockedMethod.calls.length, 1);
    assert.strictEqual(
        mockedMethod.calls[0].arguments[0],
        settings.PLUGIN_NAME,
    );
    assert.strictEqual(
        mockedMethod.calls[0].arguments[1],
...
test("PlatformAccessoryManager#registerFanAccessory registers existing accessory", (context) => {
    const existingUuid = hap.uuid.generate(deviceId + "-fan");
    const existingPlatformAccessory =
        new mockHomebridge.platform.api.platformAccessory(
            "Test Device Fan",
            existingUuid,
    ...
    platformAccessoryManager.registerFanAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#registerVerticalAirflowDirectionAccessory registers existing accessory", (context) => {
    ...
    platformAccessoryManager.registerVerticalAirflowDirectionAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#registerAutoFanSpeedSwitchAccessory registers existing accessory", (context) => {
    const existingUuid = hap.uuid.generate(deviceId + "-auto-fan-speed-switch");
    const existingPlatformAccessory =
        new mockHomebridge.platform.api.platformAccessory(
    ...
    platformAccessoryManager.registerAutoFanSpeedSwitchAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#registerDryModeSwitchAccessory registers existing accessory", (context) => {
    const existingUuid = hap.uuid.generate(deviceId + "-dry-mode-switch");
    const existingPlatformAccessory =
        new mockHomebridge.platform.api.platformAccessory(
    ...
    platformAccessoryManager.registerDryModeSwitchAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#registerEconomySwitchAccessory registers existing accessory", (context) => {
    const existingUuid = hap.uuid.generate(deviceId + "-economy-switch");
    const existingPlatformAccessory =
        new mockHomebridge.platform.api.platformAccessory(
    ...
    platformAccessoryManager.registerEconomySwitchAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#registerEnergySavingFanSwitchAccessory registers existing accessory", (context) => {
    ...
    platformAccessoryManager.registerEnergySavingFanSwitchAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#registerFanModeSwitchAccessory registers existing accessory", (context) => {
    const existingUuid = hap.uuid.generate(deviceId + "-fan-mode-switch");
    const existingPlatformAccessory =
        new mockHomebridge.platform.api.platformAccessory(
    ...
    platformAccessoryManager.registerFanModeSwitchAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#registerMinimumHeatModeSwitchAccessory registers existing accessory", (context) => {
    ...
    platformAccessoryManager.registerMinimumHeatModeSwitchAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#registerPowerfulSwitchAccessory registers existing accessory", (context) => {
    const existingUuid = hap.uuid.generate(deviceId + "-powerful-switch");
    const existingPlatformAccessory =
        new mockHomebridge.platform.api.platformAccessory(
    ...
    platformAccessoryManager.registerPowerfulSwitchAccessory(
        deviceId,
        deviceName,
        deviceModel,
    );
...
test("PlatformAccessoryManager#unregisterThermostatAccessory unregisters existing accessory", (context) => {
    ...
    platformAccessoryManager.unregisterThermostatAccessory(
        deviceId,
        deviceName,
    );

    const mockedMethod =
        mockHomebridge.platform.api.unregisterPlatformAccessories.mock;
    assert.strictEqual(mockedMethod.calls.length, 1);
    assert.strictEqual(
        mockedMethod.calls[0].arguments[0],
        settings.PLUGIN_NAME,
...
test("PlatformAccessoryManager#unregisterVerticalSlatsAccessory unregisters existing accessory", (context) => {
    const existingUuid = hap.uuid.generate(deviceId + "-vertical-slats");
    const existingPlatformAccessory =
        new mockHomebridge.platform.api.platformAccessory(
    ...
    platformAccessoryManager.unregisterVerticalSlatsAccessory(
        deviceId,
        deviceName,
    );
...
test("PlatformAccessoryManager#unregisterVerticalAirflowDirectionAccessory unregisters existing accessory", (context) => {
    ...
    platformAccessoryManager.unregisterVerticalAirflowDirectionAccessory(
        deviceId,
        deviceName,
    );
...
test("PlatformAccessoryManager#unregisterDryModeSwitchAccessory unregisters existing accessory", (context) => {
    ...
    platformAccessoryManager.unregisterDryModeSwitchAccessory(
        deviceId,
        deviceName,
    );
...
test("PlatformAccessoryManager#unregisterEconomySwitchAccessory unregisters existing accessory", (context) => {
    ...
    platformAccessoryManager.unregisterEconomySwitchAccessory(
        deviceId,
        deviceName,
    );
...
test("PlatformAccessoryManager#unregisterEnergySavingFanSwitchAccessory unregisters existing accessory", (context) => {
    ...
    platformAccessoryManager.unregisterEnergySavingFanSwitchAccessory(
        deviceId,
        deviceName,
    );
...
test("PlatformAccessoryManager#unregisterFanModeSwitchAccessory unregisters existing accessory", (context) => {
    ...
    platformAccessoryManager.unregisterFanModeSwitchAccessory(
        deviceId,
        deviceName,
    );
...
test("PlatformAccessoryManager#unregisterMinimumHeatModeSwitchAccessory unregisters existing accessory", (context) => {
    ...
    platformAccessoryManager.unregisterMinimumHeatModeSwitchAccessory(
        deviceId,
        deviceName,
    );
...
test("PlatformAccessoryManager#unregisterPowerfulSwitchAccessory unregisters existing accessory", (context) => {
    ...
    platformAccessoryManager.unregisterPowerfulSwitchAccessory(
        deviceId,
        deviceName,
    );
