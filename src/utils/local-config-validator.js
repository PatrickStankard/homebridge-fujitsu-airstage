            ...
            arp.getMAC(ipAddress, (error, mac) => {
                if (error) {
                    return resolve({
                        ...
                        details:
                            "The ARP table may not contain this IP address. This is unexpected as HTTP connectivity was confirmed. Try manually adding the device ID (MAC address) to your config.",
                    });
                }
