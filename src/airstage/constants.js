...
module.exports.OPERATION_MODE_TO_PARAMETER_VALUE_MAP[
    module.exports.OPERATION_MODE_AUTO
] = apiv1.constants.PARAMETER_OPERATION_MODE_AUTO;
module.exports.OPERATION_MODE_TO_PARAMETER_VALUE_MAP[
    module.exports.OPERATION_MODE_COOL
] = apiv1.constants.PARAMETER_OPERATION_MODE_COOL;
module.exports.OPERATION_MODE_TO_PARAMETER_VALUE_MAP[
    module.exports.OPERATION_MODE_DRY
] = apiv1.constants.PARAMETER_OPERATION_MODE_DRY;
module.exports.OPERATION_MODE_TO_PARAMETER_VALUE_MAP[
    module.exports.OPERATION_MODE_FAN
] = apiv1.constants.PARAMETER_OPERATION_MODE_FAN;
module.exports.OPERATION_MODE_TO_PARAMETER_VALUE_MAP[
    module.exports.OPERATION_MODE_HEAT
] = apiv1.constants.PARAMETER_OPERATION_MODE_HEAT;
...
module.exports.FAN_SPEED_TO_PARAMETER_VALUE_MAP[module.exports.FAN_SPEED_AUTO] =
    apiv1.constants.PARAMETER_FAN_SPEED_AUTO;
module.exports.FAN_SPEED_TO_PARAMETER_VALUE_MAP[
    module.exports.FAN_SPEED_QUIET
] = apiv1.constants.PARAMETER_FAN_SPEED_QUIET;
module.exports.FAN_SPEED_TO_PARAMETER_VALUE_MAP[module.exports.FAN_SPEED_LOW] =
    apiv1.constants.PARAMETER_FAN_SPEED_LOW;
module.exports.FAN_SPEED_TO_PARAMETER_VALUE_MAP[
    module.exports.FAN_SPEED_MEDIUM
] = apiv1.constants.PARAMETER_FAN_SPEED_MEDIUM;
module.exports.FAN_SPEED_TO_PARAMETER_VALUE_MAP[module.exports.FAN_SPEED_HIGH] =
    apiv1.constants.PARAMETER_FAN_SPEED_HIGH;
...
module.exports.TOGGLE_TO_PARAMETER_VALUE_MAP[module.exports.TOGGLE_ON] =
    apiv1.constants.PARAMETER_ON;
module.exports.TOGGLE_TO_PARAMETER_VALUE_MAP[module.exports.TOGGLE_OFF] =
    apiv1.constants.PARAMETER_OFF;

module.exports.PARAMETER_VALUE_TO_TOGGLE_MAP = {};
module.exports.PARAMETER_VALUE_TO_TOGGLE_MAP[apiv1.constants.PARAMETER_ON] =
    module.exports.TOGGLE_ON;
module.exports.PARAMETER_VALUE_TO_TOGGLE_MAP[apiv1.constants.PARAMETER_OFF] =
    module.exports.TOGGLE_OFF;
...
module.exports.VALID_FAHRENHEIT_VALUES = Object.keys(
    module.exports.FAHRENHEIT_TO_CELSIUS_MAP,
);
module.exports.VALID_CELSIUS_VALUES = Object.keys(
    module.exports.CELSIUS_TO_FAHRENHEIT_MAP,
);
