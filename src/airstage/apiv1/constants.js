...
module.exports.PATH_DEVICES_ALL_AUTHORIZE_REQUEST_TYPE =
    "/apiv1/devices/all/authorize_request/type";
module.exports.PATH_DEVICES_SET_PARAMETERS_REQUEST =
    "/apiv1/devices/%1/set_parameters_request";
...
// Message codes
module.exports.MESSAGE_CODE_INVALID_LOGIN =
    "AIRSTAGE_POST_USERS_SIGNIN_EMAIL_PASSWORD_INVALID";
