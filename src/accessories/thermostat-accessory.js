...
class ThermostatAccessory extends Accessory {
    constructor(platform, accessory) {
        ...
        this._characteristicState[
            this.Characteristic.CurrentHeatingCoolingState.UUID
        ] = undefined;
        this._characteristicState[
            this.Characteristic.TargetHeatingCoolingState.UUID
        ] = undefined;
        this._characteristicState[this.Characteristic.CurrentTemperature.UUID] =
            undefined;
        this._characteristicState[this.Characteristic.TargetTemperature.UUID] =
            undefined;
        this._characteristicState[
            this.Characteristic.TemperatureDisplayUnits.UUID
        ] = undefined;
    }
                ...
                this.airstageClient.getOperationMode(
                    ...
                    function (error, operationMode) {
                        ...
                        if (
                            ...
                            operationMode ===
                            airstage.constants.OPERATION_MODE_FAN
                        ) {
                            currentHeatingCoolingState =
                                this.Characteristic.CurrentHeatingCoolingState
                                    .OFF;
    ...
    setTargetHeatingCoolingState(value, callback) {
        ...
        this.platform.log.info(
            `[Thermostat] Setting target heating/cooling state: ${modeName}`,
        );
        ...
        this.airstageClient.getPowerState(
            ...
            function (error, powerState) {
                ...
                if (
                    value === this.Characteristic.TargetHeatingCoolingState.OFF
                ) {
                    if (powerState === airstage.constants.TOGGLE_ON) {
                        this.airstageClient.setPowerState(
                            ...
                            function (error) {
                                if (error) {
                                    this.platform.log.info(
                                        `[Thermostat] Set target heating/cooling state failed: ${error.message}`,
                                    );
                                    return this._handleError(
                                        methodName,
                                        error,
                                ...
                                this.platform.log.info(
                                    `[Thermostat] Set target heating/cooling state completed: OFF`,
                                );
                                this._logMethodCallResult(
                                    methodName,
                                    null,
                        ...
                        this.platform.log.info(
                            `[Thermostat] Set target heating/cooling state completed: OFF (already off)`,
                        );
    ...
    getCurrentTemperature(callback) {
        ...
        this.platform.log.debug(
            `[Thermostat] Requesting indoor temperature with scale: ${airstage.constants.TEMPERATURE_SCALE_CELSIUS}`,
        );
        ...
        this.airstageClient.getIndoorTemperature(
            ...
            function (error, indoorTemperature) {
                ...
                this.platform.log.debug(
                    `[Thermostat] Received indoor temperature from client: ${indoorTemperature}°C`,
                );
    ...
    getTargetTemperature(callback) {
        ...
        this.platform.log.debug(
            `[Thermostat] Requesting target temperature with scale: ${airstage.constants.TEMPERATURE_SCALE_CELSIUS}`,
        );
        ...
        this.airstageClient.getTargetTemperature(
            ...
            function (error, targetTemperature) {
                ...
                this.platform.log.debug(
                    `[Thermostat] Received target temperature from client: ${targetTemperature}°C`,
                );
    ...
    setTargetTemperature(value, callback) {
        ...
        this.platform.log.info(
            `[Thermostat] Setting target temperature: ${value}°C`,
        );
        ...
        this.airstageClient.setTargetTemperature(
            ...
            function (error, setTemperature) {
                if (error) {
                    this.platform.log.info(
                        `[Thermostat] Set target temperature failed: ${error.message}`,
                    );
                    return this._handleError(
                        methodName,
                        error,
                ...
                this.platform.log.info(
                    `[Thermostat] Set target temperature completed: ${setTemperature}°C`,
                );
                this._logMethodCallResult(methodName, null, null);
                ...
                this.platform.log.debug(
                    `[Thermostat] Optimistically updated TargetTemperature characteristic to ${setTemperature}°C`,
                );
            }.bind(this),
        );
    }
    ...
    getTemperatureDisplayUnits(callback) {
        ...
        this.airstageClient.getTemperatureScale(
            function (error, temperatureScale) {
                ...
                this.platform.log.debug(
                    `[Thermostat] Client temperature scale: ${temperatureScale}`,
                );
                ...
                if (
                    ...
                    this.platform.log.debug(
                        `[Thermostat] Mapped to HomeKit: CELSIUS`,
                    );
                } else if (
                    temperatureScale ===
                    ...
                    this.platform.log.debug(
                        `[Thermostat] Mapped to HomeKit: FAHRENHEIT`,
                    );
                }
    ...
    setTemperatureDisplayUnits(value, callback) {
        ...
        this.platform.log.info(
            `[Thermostat] Setting temperature display units: ${scaleName}`,
        );
        ...
        this.airstageClient.setTemperatureScale(
            ...
            function (error) {
                if (error) {
                    this.platform.log.info(
                        `[Thermostat] Set temperature display units failed: ${error.message}`,
                    );
                    return this._handleError(
                        methodName,
                        error,
                ...
                this.platform.log.info(
                    `[Thermostat] Set temperature display units completed: ${scaleName}`,
                );
                this._logMethodCallResult(methodName, null, null);
    ...
    _setOperationMode(methodName, operationMode, callback) {
        ...
        this.airstageClient.setOperationMode(
            ...
            function (error) {
                ...
                this.platform.log.info(
                    `[Thermostat] Set target heating/cooling state completed: ${modeName}`,
                );
                this._logMethodCallResult(methodName, null, null);
